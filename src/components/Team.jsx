...
import slider_img1 from "../assets/images/png/slider_img1.png";
import slider_img2 from "../assets/images/png/slider_img2.png";
import team_para from "../assets/images/png/team_para.png";
  ...
  return (
    <section className=" bg-black py-5">
      <div className=" position-absolute d-none d-xxl-block">
        <img src={team_para} alt="" />
      </div>
      
      <Container>
        <p className=" text-white fs_3xl ff_lato_700 text-center pb-4">
          Meet the<span className=" clr_cream"> Team</span>
        </p>
        <Row className="w-100 mx90 py-xl-5">
          <Slider {...settings}>
            <Col lg={6} xs={12}>
                ...
                <Row className="align-items-center">
                  ...
                  <Col lg={6} className="text-center">
                    <div className="pb-2">
                      ...
                      <a href="#" className="ff_lato_400 fs_xsm text-black">
